...
namespace cgs::graphics::rhi
{
    ...
    public:
        ...
        Semaphore& operator=(Semaphore&&) noexcept = delete; // Move assignment operator
    ...
    private:
        [[maybe_unused]] const Device& mDevice; // Reference to the device this semaphore belongs to
